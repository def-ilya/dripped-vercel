  ...
  return (
    ...
    >
      <Image
        ...
        className="w-[80vw] md:w-[550px] md:h-[550px] m-auto h-full object-contain object-center flex-shrink-0 md:flex-shrink-none snap-start md:col-span-2 border border-gray-200 rounded-lg"
      />
