...
d){return f.current.useReducer(a,b,d)};b.useRef=function(a){return f.current.useRef(a)};b.useState=function(a){return f.current.useState(a)};b.useSyncExternalStore=function(a,b,d){return f.current.useSyncExternalStore(a,b,d)};b.useTransition=function(){return f.current.useTransition()};b.version="18.0.0-rc.0-experimental-529dc3ce8-20220124"});
})();
